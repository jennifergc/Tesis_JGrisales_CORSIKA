\newpage
\chapter{APÉNDICE B: Parámetros de los nuevos perfiles atmosféricos construidos con GDAS.}
\label{sec:apendiceB}

%Corregir los valores de altura en cada tabla que están iguales y no es así cambian en cada mes.
...
\hline
\textbf{Distancia {[}km{]}} & \multicolumn{3}{c|}{\cellcolor[HTML]{BFE7B2}\textbf{\#Parámetros atmosféricos A,B,C}} \\ \hline
...
\end{center} %\vspace{0.1em}
		%	{\normalsize \textbf{Fuente}: \cite[][]{Meteo1} }
		\end{minipage}
\end{table}
